...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    ...
    <form class="form-inline my-2 my-lg-0" method="POST" action="traitement.php">
...
<main role="main" class="container">
  ...
  <?php //print_r($_SERVER)  ?>
   <a href="index.php"> <h1><?php  echo $_SESSION["email"];  ?></h1> Cliquez-ici pour vous déconnecter.</a>
  ...
  <button class="btn btn-primary" type="button" data-toggle="collapse" data-target=".multi-collapse" aria-expanded="false" aria-controls="multiCollapseExample1 multiCollapseExample2">Toggle first elemetn</button>
</p>
<div class="row">
  <div class="col">
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" id="image" rows="3" name="image" value="" minlenght="5" maxlenght="100"></textarea>
    <small id="imageHelp" class="form-text text-muted">Liste des ingrédients.</small>
  </div>
  <div class="form-group">
    <label for="image">Nbr personnes</label>
  ...
  <div class="form-group">
    <label for="image">Photo de la recette *</label>
    <input type="text" class="form-control" id="image" aria-describedby="image" name="image" value="" minlength="5" maxlength="255" required>
    <small id="imageHelp" class="form-text text-muted">URL de la photo de la recette</small>
  </div>
  <div class="form-group">
