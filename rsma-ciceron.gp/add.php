    ...
    <div class="container">
        <form action="add.php" method="POST">
            <div class="form-group">
                ...
                <input type="date" class="form-control" name="name" placeholder="Enter name" required="">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="pays">
                    ...
                    <optgroup label="Europe">
                        ...
                        <option value="exRepubliqueYougoslaveDeMacedoine">Ex-République Yougoslave de Macédoine
                        </option>
